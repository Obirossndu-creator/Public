...
const uiText = {
  en: {
    ...
    heroTitle: "Structural Engineering, BIM, Management for a Coordinated, Resilient Built Environments.",
  ...
  de: {
    ...
    heroTitle: "Tragwerksplanung, BIM, Baumanagement für ein koordiniertes und resilientes Bauprojekt.",
