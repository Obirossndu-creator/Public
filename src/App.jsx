...
const uiText = {
  en: {
    ...
    heroTitle: "Structural Engineering|BIM|Construction|Risk Analysis for a Coordinated, Resilient Built Environments.",
  ...
  de: {
    ...
    heroTitle: "Tragwerksplanung|BIM|Baumanagement|Risikoanalyse für ein koordiniertes und resilientes Bauprojekt.",
