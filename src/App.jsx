...
const zentroaVisualCards = makeCards([
  ["Construction Phase", "Welding Works", "Site Progress", "from-orange-200 via-orange-700 to-stone-950", "/portfolio_assets/marketing suite in cons.png"],
...
const uiText = {
  en: {
    ...
    heroTitle: "Structural Engineering/ Buidling Information Modelling/ Construction Management/ Risk Analysis for a Coordinated, Resilient Built Environments.",
    ...
    contact: "Contact",
    aboutLabel: "About",
    aboutTitle: "Construction, BIM & Structural Engineer",
    ...
    contactText: "Available for BIM, Construction, Structural Engineering and Resilience-oriented Engineering Opportunities.",
    profileBadge: "MSc Natural Hazards & Risks in Structural Engineering",
    profileText: "BIM-focused structural engineering graduate student combining Structural engineering, seismic assessment, GIS-based risk analysis and practical construction management experience.",
  ...
  de: {
    ...
    navContact: "Kontakt",
    heroBadge: "BIM-Ingenieur • Tragwerksplanung • Bauen • Risikoanalyse",
    heroTitle: "Tragwerksplanung / Building Information Modeling / Baumanagement / Risikoanalyse für ein koordiniertes und resilientes Bauprojekt.",
    ...
    aboutTitle: "BIM- und Tragwerksingenieur",
        ...
        <section id="experience" className="px-6 py-20">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {[
                ["Rolling Bricks LTD  (2021 - 2024)", "Project Manager / Construction Coordination"],
                ...
                ["PROJECTS: Project Zentroa", "Residential & housing development", "Cordination of site operations, scheduling, documentation, contractor coordination, payment authorization, quality control and progress tracking across project phases."],
